...
% 25、42、70分别是波长
[Acc_TriRec_25, TriDB_TriRec_25, maxV_TriRec_25, minV_TriRec_25, BW_TriRec_25, slope_TriRec_25] = tri_rec_paral(25, para);
[Acc_TriRec_42, TriDB_TriRec_42, maxV_TriRec_42, minV_TriRec_42, BW_TriRec_42, slope_TriRec_42] = tri_rec_paral(42, para);
[Acc_TriRec_70, TriDB_TriRec_70, maxV_TriRec_70, minV_TriRec_70, BW_TriRec_70, slope_TriRec_70] = tri_rec_paral(70, para);
[Acc_TriRec_120, TriDB_TriRec_120, maxV_TriRec_120, minV_TriRec_120, BW_TriRec_120, slope_TriRec_120] = tri_rec_paral(120, para);
...
% semilogx((lamda), ((Acc_3Rec_25)), ':b','LineWidth',2);
% semilogx((lamda), ((Acc_3Rec_42)), ':g','LineWidth',2);
% semilogx((lamda), ((Acc_3Rec_70)), ':r','LineWidth',2);
% semilogx((lamda), ((Acc_3Rec_120)), ':k','LineWidth',2);

% semilogx((lamda), ((Acc_2Rec_25)), '-.b','LineWidth',2);
% semilogx((lamda), ((Acc_2Rec_42)), ':g','LineWidth',2);
% semilogx((lamda), ((Acc_2Rec_70)), ':r','LineWidth',2);
% semilogx((lamda), ((Acc_2Rec_120)), ':k','LineWidth',2);

% semilogx((lamda), ((Acc_1Rec_25)), '--b','LineWidth',2);
% semilogx((lamda), ((Acc_2Rec_42)), ':g','LineWidth',2);
% semilogx((lamda), ((Acc_2Rec_70)), ':r','LineWidth',2);
% semilogx((lamda), ((Acc_2Rec_120)), ':k','LineWidth',2);

semilogx((lamda), 0.707, 'c','LineWidth',4);           %3db点
semilogx((lamda), 0.1, 'y', 'LineWidth', 4);            % 0.1 
...
semilogx((lamda), ((Acc_TriRec_25)), 'b','LineWidth',2);
hold on
semilogx((lamda), ((Acc_Trap_25)), 'g','LineWidth',2);
semilogx((lamda), ((Acc_4Rec_25)), 'r','LineWidth',2);
semilogx((lamda), ((Acc_3Rec_25)), ':r','LineWidth',2);
semilogx((lamda), ((Acc_2Rec_25)), '-.r','LineWidth',2);
semilogx((lamda), ((Acc_1Rec_25)), '--r','LineWidth',2);
semilogx((lamda), 0.707, 'c','LineWidth',4);           %3db点
xlabel('Wavelength(m)');ylabel('Amplitude');
title(Title);
grid on
