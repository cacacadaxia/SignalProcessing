...
figure(101);suptitle('Ò»½×Êý×Ö¿¹»ìµþ')
...
% figure();suptitle ('¶þ½×Êý×Ö¿¹»ìµþÂË²¨Æ÷');
...
% ¶þ½×²¹³¥ÂË²¨Æ÷
% %a=¦¸_2 l  b=¦¸_2 ¡Ì(1-l^2 ) l=1/2 ¦¸_2=10^5/2^14 a=¦¸_2 l  b=¦¸_2 ¡Ì(1-l^2 )
% %l=1/2 ¦¸_2=10^5/2^14
% w2 = (10^5)/(2^14);
% t = 9/150;
% w2t = w2*t;
...
[h2 f2] = freqz(b2,a2,1000000,500);
%figure();suptitle ('¶þ½×Êý×Ö¿¹»ìµþ²¹³¥ÂË²¨Æ÷');
semilogx(v./f2,20*log10(abs(h2)));hold on
%t = 0.0225;
t= 0.01125;w2t = w2*t;
%b2 = [1+a*t+aa*t*t -2*(1-aa*t*t) 1-a*t+aa*t*t];
