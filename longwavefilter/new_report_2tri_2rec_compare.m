...
fprintf('%4.3f\t%4.3f\t%4.3f\n',TriDB_TriRec_120,maxV_TriRec_120,BW_TriRec_120)

% plot 25
fig = figure;
% semilogx((lamda), ((Acc_TriRec_25)), 'LineWidth',2);
...
% % plot 42
% figure;
% semilogx((lamda), ((Acc_TriRec_42)), 'LineWidth',2);
...
% semilogx((lamda), ((Acc_TriRec_70)),'LineWidth',2);
% xlabel('Wavelength /m')
% ylabel('Magnitude /dB')
% set(gca,'Fontname','Times New Roman','fontsize',14);
% plot 120
% % figure;
semilogx((lamda), ((Acc_TriRec_120)), 'LineWidth',2);
...
% figure;
% plot_line_func(Acc_TriRec_25,lamda,25);
% h2 = semilogx((lamda), ((Acc_TriRec_25)),'LineWidth',2);
% legend(h2,'After modification')
% xlabel('Wavelength /m')
% ylabel('Magnitude /dB')
% set(gca,'Fontname','Times New Roman','fontsize',14);
% % % plot 70
% % figure;
% plot_line_func(Acc_TriRec_42,lamda,42);
% h2 = semilogx((lamda), ((Acc_TriRec_42)),'LineWidth',2);
% legend(h2,'After modification')
% xlabel('Wavelength /m')
% ylabel('Magnitude /dB')
% set(gca,'Fontname','Times New Roman','fontsize',14);
...
% figure;
% plot_line_func(Acc_TriRec_70,lamda,70);
% h2 = semilogx((lamda), ((Acc_TriRec_70)),'LineWidth',2);
% legend(h2,'After modification')
% xlabel('Wavelength /m')
% ylabel('Magnitude /dB')
% set(gca,'Fontname','Times New Roman','fontsize',14);
...
% % figure;
plot_line_func(Acc_TriRec_120,lamda,120);
h2 = semilogx((lamda), ((Acc_TriRec_120)), 'b','LineWidth',2);
legend(h2,'After modification')
xlabel('Wavelength /m')
ylabel('Magnitude /dB')
set(gca,'Fontname','Times New Roman','fontsize',14);
